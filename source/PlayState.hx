...
class PlayState extends MusicBeatState
{
	...
	public static var HUDFont:String = "vcr.ttf";
	var timeTxt:FlxText;
	...
	override public function create()
	{
		...
		timeTxt.setFormat(Paths.font(HUDFont), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		botplayTxt.setFormat(Paths.font(HUDFont), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
